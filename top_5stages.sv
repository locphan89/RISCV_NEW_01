...
(
  ...
  // logic                            rt_ifid_match;
   ...
   assign idex_wr_reg = (stall | id_mem_wr_sig | id_jmp_sig | id_branch_sig) ? 
                        '0 : id_wr_reg; 
