...
module forward_branch_nopipe_unit_6stage (
    ...
    // WB stage signals (for LW→BEQ forwarding)
    input logic [R_ADDR_WIDTH-1:0] wb_wr_reg,      
    input logic                    wb_mem2reg_sig, 
    ...
    // Forward từ WB stage (LW result)
    assign branch_fw_rs1_from_wb = (wb_wr_reg == id_rs1) && wb_mem2reg_sig;  
    ...
    // Forward từ WB stage (LW result)
    assign branch_fw_rs2_from_wb = (wb_wr_reg == id_rs2) && wb_mem2reg_sig;  
