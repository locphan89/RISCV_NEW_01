...
module alu_opt (
   ...
   unique case (ex_aluc_i)
      'd1: ex_alu_o = alu_sub;
      'd2: ex_alu_o = ex_a_i & ex_b_i;
      'd3: ex_alu_o = ex_a_i | ex_b_i;
      'd4: ex_alu_o = ex_a_i ^ ex_b_i;
      'd5: ex_alu_o = ex_a_i << ex_b_i[4:0];
      'd6: ex_alu_o = ex_a_i >> ex_b_i[4:0];
      'd7: ex_alu_o = {{(DATA_WIDTH-1){1'b0}}, slt_result};
